...
var Backup, async, child_process, config, dateFormat, dbox, doBackup, exec, fs, job, mkdirp, path, rule, schedule, util, yaml, _;
...
Backup = (function() {
  ...
  function Backup() {
    ...
    this.sourceDir = path.join(config.source_dir, datedFolder);
    this.destDir = path.join(config.destination_dir, datedFolder);
